                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        @if(!$surat->file_surat_pernyataan)
                                            <!-- Show Generate Button for pending requests that don't have a document yet -->
                                            <a href="{{ route('admin.surat-pernyataan.generate', $surat->id_surat_pernyataan) }}"
                                               class="btn btn-sm btn-primary me-1">
                                                <i class="fas fa-file-pdf"></i> Buat Dokumen
                                            </a>
                                        @else
                                            <a href="{{ route('admin.surat-pernyataan.show', $surat->id_surat_pernyataan) }}"
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <h6 class="text-secondary">Belum ada surat pernyataan yang diajukan</h6>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
