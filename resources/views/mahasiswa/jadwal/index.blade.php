                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        @if($item->file_info)
                                            <a href="{{ route('mahasiswa.jadwal.preview', $item->jadwal_id) }}?t={{ time() }}" class="btn btn-link text-info px-2 mb-0" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Pratinjau Berkas">
