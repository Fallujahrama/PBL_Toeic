...
<div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
    ...
    <h6 class="font-weight-bolder mb-0">Edit Pendaftaran</h6>
</div>
        ...
        <div class="card animate-card" data-aos="fade-up">
            <div class="card-header pb-0">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0">Edit Pendaftaran TOEIC</h5>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('pendaftaran.update', $pendaftaran->id_pendaftaran) }}" method="POST" enctype="multipart/form-data" id="pendaftaran-form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6" data-aos="fade-right" data-aos-delay="100">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nim" id="nim" class="form-control @error('nim') is-invalid @enderror" value="{{ old('nim', $pendaftaran->nim) }}" required>
                                </div>
                                @error('nim')
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="form-group">
                                ...
                                <div class="document-upload-container">
                                    <div class="document-preview has-preview" id="ktp-preview">
                                        @if(pathinfo($pendaftaran->file_ktp, PATHINFO_EXTENSION) == 'pdf')
                                    ...
                                    <div class="document-upload-button">
                                        ...
                                        <label for="file_ktp" class="btn btn-outline-primary w-100">
                                            <i class="fas fa-upload me-2"></i>Ganti KTP
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="form-group">
                                ...
                                <div class="document-upload-container">
                                    <div class="document-preview has-preview" id="ktm-preview">
                                        @if(pathinfo($pendaftaran->file_ktm, PATHINFO_EXTENSION) == 'pdf')
                                            <i class="fas fa-file-pdf" style="font-size: 3rem; color: #ef4444;"></i>
                                            <span>KTM (PDF)</span>
                                        @else
                                    ...
                                    <div class="document-upload-button">
                                        ...
                                        <label for="file_ktm" class="btn btn-outline-primary w-100">
                                            <i class="fas fa-upload me-2"></i>Ganti KTM
                                        </label>
                                    </div>
                                </div>
                                <small class="text-muted">Format: JPG, PNG, PDF. Maks: 2MB</small>
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="form-group">
                                ...
                                <div class="document-upload-container">
                                    <div class="document-preview has-preview" id="foto-preview">
